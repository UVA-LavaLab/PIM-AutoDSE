...
struct PimDeviceProperties {
  ...
  uint64_t bufferSize = 0; // Size in bits
 ...
 * @param bufferSize      Optional on-chip buffer size (bits) for the device (default is 0). This parameter is only applicable for AiM.
