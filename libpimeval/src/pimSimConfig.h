...
public:
  ...
  unsigned getVectorRegisterCount() const { return m_vectorRegisterCount; }
  unsigned getVectorRegisterBitWidth() const { return m_vectorRegisterBitWidth; }
  unsigned getScalarRegisterCount() const { return m_scalarRegisterCount; }
  unsigned getScalarRegisterBitWidth() const { return m_scalarRegisterBitWidth; }
...
private:
  ...
  inline static const std::string m_cfgVarVectorRegisterCount = "vector_register_count";
  inline static const std::string m_cfgVarVectorRegisterBitWidth = "vector_register_bitwidth";
  inline static const std::string m_cfgVarScalarRegisterCount = "scalar_register_count";
  inline static const std::string m_cfgVarScalarRegisterBitWidth = "scalar_register_bitwidth";
  ...
  inline static const std::string m_envVarVectorRegisterCount = "PIMEVAL_VECTOR_REGISTER_COUNT";
  inline static const std::string m_envVarVectorRegisterBitWidth = "PIMEVAL_VECTOR_REGISTER_BIT_WIDTH";
  inline static const std::string m_envVarScalarRegisterCount = "PIMEVAL_SCALAR_REGISTER_COUNT";
  inline static const std::string m_envVarScalarRegisterBitWidth = "PIMEVAL_SCALAR_REGISTER_BIT_WIDTH";
  ...
  inline static const std::vector<std::string> m_envVarList = {
    ...
    m_envVarLoadBalance,
    m_envVarBufferSize,
    m_envVarVectorRegisterCount,
    m_envVarVectorRegisterBitWidth,
    m_envVarScalarRegisterCount,
    m_envVarScalarRegisterBitWidth,
  };
  ...
  unsigned m_debug;
  bool m_loadBalanced;
  unsigned m_vectorRegisterCount;
  unsigned m_vectorRegisterBitWidth;
  unsigned m_scalarRegisterCount;
  unsigned m_scalarRegisterBitWidth;
