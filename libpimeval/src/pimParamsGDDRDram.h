...
public:
  ...
  double getPjRead_L() const override { return m_VDD * 0.15 * m_tCK * m_tCCD_L * (m_IDD4R - m_IDD3N); } // read power per chip (data copy)
  double getPjWrite_L() const override { return m_VDD * 0.15 * m_tCK * m_tCCD_L * (m_IDD4W - m_IDD3N); } // write power per chip (data copy)
  double getPjRead_S() const override { return m_VDD * 0.15 * m_tCK * m_tCCD_S * (m_IDD4R - m_IDD3N); } // read power per chip (data copy)
  double getPjWrite_S() const override { return m_VDD * 0.15 * m_tCK * m_tCCD_S * (m_IDD4W - m_IDD3N); } // write power per chip (data copy)
  ...
  double gettRCDRD() const override { return m_tRCDRD; }
  double gettRCDWR() const override { return m_tRCDWR; }
...
private:
  ...
  // Extended
  double m_typicalRankBW = 320.3; // GB/s src: https://www.techpowerup.com/gpu-specs/geforce-gtx-1080.c2839
};
