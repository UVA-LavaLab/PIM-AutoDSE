...
//! @brief  Convert PimAPI call to string
std::string pimUtils::pimApiToStr(void *apiPtr)
{
  if (apiPtr == reinterpret_cast<void*>(&pimCreateDevice)) {
    return "pimCreateDevice";
  } else if (apiPtr == reinterpret_cast<void*>(&pimDeleteDevice)) {
    return "pimDeleteDevice";
  } else if (apiPtr == reinterpret_cast<void*>(&pimAlloc)) {
    return "pimAlloc";
  } else if (apiPtr == reinterpret_cast<void*>(&pimAllocAssociated)) {
    return "pimAllocAssociated";
  } else if (apiPtr == reinterpret_cast<void*>(&pimFree)) {
    return "pimFree";
  } else if (apiPtr == reinterpret_cast<void*>(&pimCopyHostToDevice)) {
    return "pimCopyHostToDevice";
  } else if (apiPtr == reinterpret_cast<void*>(&pimCopyDeviceToHost)) {
    return "pimCopyDeviceToHost";
  } else if (apiPtr == reinterpret_cast<void*>(&pimCopyDeviceToDevice)) {
    return "pimCopyDeviceToDevice";
  } else if (apiPtr == reinterpret_cast<void*>(&pimCopyObjectToObject)) {
    return "pimCopyObjectToObject";
