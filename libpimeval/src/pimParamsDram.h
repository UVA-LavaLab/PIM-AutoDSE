...
public:
  ...
  virtual double getPjRead_L() const = 0;
  virtual double getPjWrite_L() const = 0;
  virtual double getPjRead_S() const = 0;
  virtual double getPjWrite_S() const = 0;
  virtual double getPjPrecharge() const = 0;
  virtual double getPjActivate() const = 0;
  virtual double gettRCDRD() const = 0;
  virtual double gettRCDWR() const = 0;
